...
class Boy:
    ...
    def update(self):
        ...
        self.x = clamp(25,
                       self.x,
                       server.background.w - 25)
        self.y = clamp(25,
                       self.y,
                       server.background.h - 25)
    ...
    def draw(self):
        ...
        self.font.draw(sx - 100, sy + 60, f'({self.x:.1f}, {self.y:.1f})', (255, 255, 0))
        self.font.draw(sx - 100, sy + 80, f'ball : {self.ball_count}', (255, 255, 0))
